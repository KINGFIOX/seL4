...
#define seL4_RISCV_4K_Page seL4_LoongArch_4K_Page
#define seL4_RISCV_Mega_Page seL4_LoongArch_Mega_Page
#define seL4_RISCV_Giga_Page seL4_LoongArch_Giga_Page
#define seL4_RISCV_Tera_Page seL4_LoongArch_Tera_Page
#define seL4_RISCV_PageTableObject seL4_LoongArch_PageTableObject

#define RISCVPageTableMap LOONGARCHPageTableMap
#define RISCVPageTableUnmap LOONGARCHPageTableUnmap
#define RISCVPageMap LOONGARCHPageMap
#define RISCVPageUnmap LOONGARCHPageUnmap
#define RISCVPageGetAddress LOONGARCHPageGetAddress
#define RISCVASIDControlMakePool LOONGARCHASIDControlMakePool
#define RISCVASIDPoolAssign LOONGARCHASIDPoolAssign
#define RISCVIRQIssueIRQHandlerTrigger LOONGARCHIRQIssueIRQHandlerTrigger
